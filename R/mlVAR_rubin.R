...
mlVAR_rubin <- function(data_list, m){
  ...
  get_pcors <- lapply(lapply(data_list, `[[`, "mlVar00_object"), `[[`, "results")
  ...
  names(current_network_list) <- c("temporal", "between-subjects" ,"contemporaneous", "between_pcors", "contemporaneous_pcors")
